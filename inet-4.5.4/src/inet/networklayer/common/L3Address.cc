...
const IL3AddressType *L3Address::getAddressType() const
{
    switch (getType()) {
        case L3Address::NONE:
            throw cRuntimeError("Address contains no value1");
...
bool L3Address::isUnicast() const
{
    switch (getType()) {
        case L3Address::NONE:
            throw cRuntimeError("Address contains no value7");
...
bool L3Address::isMulticast() const
{
    switch (getType()) {
        case L3Address::NONE:
            throw cRuntimeError("Address contains no value2");
...
bool L3Address::isBroadcast() const
{
    switch (getType()) {
        case L3Address::NONE:
            throw cRuntimeError("Address contains no value3");
...
bool L3Address::isLinkLocal() const
{
    switch (getType()) {
        case L3Address::NONE:
            throw cRuntimeError("Address contains no value4");
...
bool L3Address::operator<(const L3Address& other) const
{
    ...
    if (type != otherType)
        ...
        switch (type) {
            case L3Address::NONE:
                throw cRuntimeError("Address contains no value5");
...
bool L3Address::matches(const L3Address& other, int prefixLength) const
{
    switch (getType()) {
        case L3Address::NONE:
            throw cRuntimeError("Address contains no value6");
