...
//mdt
simsignal_t ctrlPacketsSentSignal = cComponent::registerSignal("ctrlPacketsSent");
//simsignal_t ctrlPacketBytesSentSignal = cComponent::registerSignal("ctrlPacketBytesSent");
//
